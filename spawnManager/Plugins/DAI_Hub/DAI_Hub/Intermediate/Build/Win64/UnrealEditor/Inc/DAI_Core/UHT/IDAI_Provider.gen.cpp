...
#include "DAI_Core/Public/DAI/Core/Interfaces/IDAI_Provider.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIDAI_Provider() {}

// Begin Cross Module References
COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
DAI_CORE_API UClass* Z_Construct_UClass_UDAI_Provider();
DAI_CORE_API UClass* Z_Construct_UClass_UDAI_Provider_NoRegister();
...
template<> DAI_CORE_API UClass* StaticClass<UDAI_Provider>()
{
	return UDAI_Provider::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Core_Public_DAI_Core_Interfaces_IDAI_Provider_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDAI_Provider, UDAI_Provider::StaticClass, TEXT("UDAI_Provider"), &Z_Registration_Info_UClass_UDAI_Provider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDAI_Provider), 2902365490U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Core_Public_DAI_Core_Interfaces_IDAI_Provider_h_2168663223(TEXT("/Script/DAI_Core"),
	Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Core_Public_DAI_Core_Interfaces_IDAI_Provider_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Core_Public_DAI_Core_Interfaces_IDAI_Provider_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
