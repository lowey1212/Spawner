...
#include "DAI_Hub/Public/DAI/Core/DAIStructs.h"
...
DAI_HUB_API UScriptStruct* Z_Construct_UScriptStruct_FFactionId();
DAI_HUB_API UScriptStruct* Z_Construct_UScriptStruct_FInputSnapshot();
DAI_HUB_API UScriptStruct* Z_Construct_UScriptStruct_FPlayerStatsMap();
DAI_HUB_API UScriptStruct* Z_Construct_UScriptStruct_FQuestId();
DAI_HUB_API UScriptStruct* Z_Construct_UScriptStruct_FSaveSlotMeta();
DAI_HUB_API UScriptStruct* Z_Construct_UScriptStruct_FSpawnTag();
...
class UScriptStruct* FQuestId::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_QuestId.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FQuestId, (UObject*)Z_Construct_UPackage__Script_DAI_Hub(), TEXT("QuestId"));
	}
	return Z_Registration_Info_UScriptStruct_QuestId.OuterSingleton;
}
template<> DAI_HUB_API UScriptStruct* StaticStruct<FQuestId>()
{
...
class UScriptStruct* FFactionId::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FactionId.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFactionId, (UObject*)Z_Construct_UPackage__Script_DAI_Hub(), TEXT("FactionId"));
	}
	return Z_Registration_Info_UScriptStruct_FactionId.OuterSingleton;
}
template<> DAI_HUB_API UScriptStruct* StaticStruct<FFactionId>()
{
...
class UScriptStruct* FSpawnTag::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SpawnTag.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSpawnTag, (UObject*)Z_Construct_UPackage__Script_DAI_Hub(), TEXT("SpawnTag"));
	}
	return Z_Registration_Info_UScriptStruct_SpawnTag.OuterSingleton;
}
template<> DAI_HUB_API UScriptStruct* StaticStruct<FSpawnTag>()
{
...
class UScriptStruct* FSaveSlotMeta::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SaveSlotMeta.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSaveSlotMeta, (UObject*)Z_Construct_UPackage__Script_DAI_Hub(), TEXT("SaveSlotMeta"));
	}
	return Z_Registration_Info_UScriptStruct_SaveSlotMeta.OuterSingleton;
}
template<> DAI_HUB_API UScriptStruct* StaticStruct<FSaveSlotMeta>()
{
...
class UScriptStruct* FInputSnapshot::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputSnapshot.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputSnapshot, (UObject*)Z_Construct_UPackage__Script_DAI_Hub(), TEXT("InputSnapshot"));
	}
	return Z_Registration_Info_UScriptStruct_InputSnapshot.OuterSingleton;
}
template<> DAI_HUB_API UScriptStruct* StaticStruct<FInputSnapshot>()
{
...
class UScriptStruct* FPlayerStatsMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlayerStatsMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlayerStatsMap, (UObject*)Z_Construct_UPackage__Script_DAI_Hub(), TEXT("PlayerStatsMap"));
	}
	return Z_Registration_Info_UScriptStruct_PlayerStatsMap.OuterSingleton;
}
template<> DAI_HUB_API UScriptStruct* StaticStruct<FPlayerStatsMap>()
{
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_DAIStructs_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FQuestId::StaticStruct, Z_Construct_UScriptStruct_FQuestId_Statics::NewStructOps, TEXT("QuestId"), &Z_Registration_Info_UScriptStruct_QuestId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestId), 1052883687U) },
		{ FFactionId::StaticStruct, Z_Construct_UScriptStruct_FFactionId_Statics::NewStructOps, TEXT("FactionId"), &Z_Registration_Info_UScriptStruct_FactionId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFactionId), 2260717848U) },
		{ FSpawnTag::StaticStruct, Z_Construct_UScriptStruct_FSpawnTag_Statics::NewStructOps, TEXT("SpawnTag"), &Z_Registration_Info_UScriptStruct_SpawnTag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpawnTag), 1313730012U) },
		{ FSaveSlotMeta::StaticStruct, Z_Construct_UScriptStruct_FSaveSlotMeta_Statics::NewStructOps, TEXT("SaveSlotMeta"), &Z_Registration_Info_UScriptStruct_SaveSlotMeta, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSaveSlotMeta), 2660385370U) },
		{ FInputSnapshot::StaticStruct, Z_Construct_UScriptStruct_FInputSnapshot_Statics::NewStructOps, TEXT("InputSnapshot"), &Z_Registration_Info_UScriptStruct_InputSnapshot, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputSnapshot), 993263006U) },
		{ FPlayerStatsMap::StaticStruct, Z_Construct_UScriptStruct_FPlayerStatsMap_Statics::NewStructOps, TEXT("PlayerStatsMap"), &Z_Registration_Info_UScriptStruct_PlayerStatsMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayerStatsMap), 2062833713U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_DAIStructs_h_3786301427(TEXT("/Script/DAI_Hub"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_DAIStructs_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_DAIStructs_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
