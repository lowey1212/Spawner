...
#include "DAI_Hub/Public/DAI/Core/Interfaces/IDAI_FactionAware.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIDAI_FactionAware() {}

// Begin Cross Module References
COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
DAI_HUB_API UClass* Z_Construct_UClass_UDAI_FactionAware();
DAI_HUB_API UClass* Z_Construct_UClass_UDAI_FactionAware_NoRegister();
...
template<> DAI_HUB_API UClass* StaticClass<UDAI_FactionAware>()
{
	return UDAI_FactionAware::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_FactionAware_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDAI_FactionAware, UDAI_FactionAware::StaticClass, TEXT("UDAI_FactionAware"), &Z_Registration_Info_UClass_UDAI_FactionAware, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDAI_FactionAware), 3675923860U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_FactionAware_h_4247927662(TEXT("/Script/DAI_Hub"),
	Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_FactionAware_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_FactionAware_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
