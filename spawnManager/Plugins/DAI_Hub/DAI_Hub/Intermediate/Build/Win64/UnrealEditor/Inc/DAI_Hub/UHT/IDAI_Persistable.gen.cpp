...
#include "DAI_Hub/Public/DAI/Core/Interfaces/IDAI_Persistable.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIDAI_Persistable() {}

// Begin Cross Module References
COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
DAI_HUB_API UClass* Z_Construct_UClass_UDAI_Persistable();
DAI_HUB_API UClass* Z_Construct_UClass_UDAI_Persistable_NoRegister();
...
template<> DAI_HUB_API UClass* StaticClass<UDAI_Persistable>()
{
	return UDAI_Persistable::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_Persistable_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDAI_Persistable, UDAI_Persistable::StaticClass, TEXT("UDAI_Persistable"), &Z_Registration_Info_UClass_UDAI_Persistable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDAI_Persistable), 1125992486U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_Persistable_h_2247027153(TEXT("/Script/DAI_Hub"),
	Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_Persistable_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_githubdesktop_DAI_Hub_DAI_HubProject_Plugins_DAI_Hub_Source_DAI_Hub_Public_DAI_Core_Interfaces_IDAI_Persistable_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
